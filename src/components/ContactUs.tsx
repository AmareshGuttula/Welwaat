...
const ContactUs = () => {
  return (
    <section id="contact" className="bg-[#FAF9F7] py-20 relative overflow-hidden border-b border-[#F4522A]/20 font-inter">
      {/* Section Dot Pattern */}
      ...
      <div className="container px-4 z-10 mx-auto relative">
        ...
        <div className="relative mt-10 max-w-5xl mx-auto">
          ...
          <div className="border border-[#F4522A]/25 rounded-md bg-white shadow-[0_4px_16px_rgba(0,0,0,0.02)] relative z-10">
            ...
            {/* Inner Content */}
            <div className="p-10 md:p-14 flex flex-col md:flex-row gap-12 md:gap-20">
              {/* Left Column */}
              <div className="flex-1">
                <h3 className="font-['Playfair_Display',serif] text-[2.5rem] text-[#111] italic font-medium mb-10">
                  Get in touch
                </h3>
                ...
                <div className="mt-10">
                  ...
                  <div className="flex gap-4">
                    ...
                    <a href="#" aria-label="Instagram" className="text-[#111] hover:text-[#F4522A] transition-colors">
                    ...
                    <a href="#" aria-label="TikTok" className="text-[#111] hover:text-[#F4522A] transition-colors">
                    ...
                    <a href="#" aria-label="Twitter" className="text-[#111] hover:text-[#F4522A] transition-colors">
              ...
              <div className="flex-[1.2]">
                <form className="flex flex-col gap-6">
                  <div className="flex flex-col sm:flex-row gap-5">
                    <div className="flex flex-col flex-1 gap-2">
                      ...
                      <input type="text" id="name" placeholder="Your name" 
                        className="bg-[#F7F7F7] border border-transparent rounded-md px-6 py-4 text-[0.95rem] text-[#111] outline-none transition-all duration-200 focus:bg-white focus:border-[#F4522A] placeholder:text-[#aaa]" 
                      />
                    </div>
                    <div className="flex flex-col flex-1 gap-2">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <textarea id="message" rows={6} placeholder="Write something..." 
                      className="bg-[#F7F7F7] border border-transparent rounded-md px-6 py-4 text-[0.95rem] text-[#111] outline-none transition-all duration-200 focus:bg-white focus:border-[#F4522A] placeholder:text-[#aaa] resize-y"
                    ></textarea>
                  </div>

                  <button type="button" 
                    className="w-full bg-[#F4522A] text-white border-none rounded-md py-[18px] px-8 text-base font-medium cursor-pointer transition-all duration-200 mt-2 hover:bg-[#e04320] hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(244,82,42,0.3)] shadow-[0_4px_14px_0_rgba(244,82,42,0.39)]"
                  >
                    Send Message
                  </button>
                </form>
