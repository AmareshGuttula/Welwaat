          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10 lg:gap-12">
            ...
            <div className="col-span-1 sm:col-span-2">
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.instagram.com/welwaat/" aria-label="Instagram" className="text-[#888] hover:!text-[#F4522A] transition-colors">
                ...
                <a href="https://twitter.com/welwaat" aria-label="Twitter" className="text-[#888] hover:!text-[#F4522A] transition-colors">
